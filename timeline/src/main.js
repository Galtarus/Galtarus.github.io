import { createRouter } from './router.js?v=500adc2';
import { loadState, saveState } from './lib/storage.js?v=500adc2';
import { demoEntries } from './lib/demo-data.js?v=500adc2';
import { renderShell } from './views/shell.js?v=500adc2';
