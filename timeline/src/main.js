import { createRouter } from './router.js?v=9c2f3b1';
import { loadState, saveState } from './lib/storage.js?v=9c2f3b1';
import { demoEntries } from './lib/demo-data.js?v=9c2f3b1';
import { renderShell } from './views/shell.js?v=9c2f3b1';
